...
export default function AboutPage() {
  return (
    <main className="min-h-screen relative overflow-hidden bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 selection:bg-indigo-500 selection:text-white">
      ...
      {/* 🌟 MODERN ARKA PLAN EFEKTLERİ (Gradient Blobs) */}
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        {/* 🚀 BÖLÜM 1: HERO & GİRİŞ (Glassmorphism Kartı) */}
        <section className="relative backdrop-blur-xl bg-white/60 border border-white/50 rounded-3xl shadow-2xl p-8 md:p-12 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            {/* Profil Resmi (Animasyonlu Çerçeve) */}
            ...
            <div className="flex-1 text-center md:text-left space-y-6">
              <div>
                <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight">
                   Hilmi <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Kılavuz</span>
                </h1>
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                ...
                başarısıyla akademik hayatımı sürdürürken, Android dünyasında Kotlin ile geliştirdiğim modern uygulamalarla pratik yetkinliğimi kanıtladım. 
                Şimdi ise kodun arka kapılarını keşfetmek için <strong>Siber Güvenlik</strong> dünyasına derin bir dalış yapıyorum.
              </p>

              {/* Sosyal Butonlar (Modern Stil) */}
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                ...
                <Link href="https://www.linkedin.com/in/hilmi-kılavuz-48767a24a/" target="_blank" className="group relative px-6 py-3 bg-[#0077b5] text-white rounded-xl overflow-hidden transition-all hover:shadow-lg hover:shadow-blue-500/30">
        ...
        {/* 🛠️ BÖLÜM 2: YETENEKLER (Modern Grid) */}
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Native uygulama geliştirmede modern mimariler.
              </p>
            ...
            <div className="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">Backend & .NET</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
                Sağlam ve ölçeklenebilir arka uç sistemleri.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-md">C#</span>
            ...
            <div className="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Verilerin güvenli depolanması ve hızlı erişimi.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
            ...
            <div className="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Sistem açıkları ve savunma stratejileri.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-red-100 text-red-700 text-xs font-semibold rounded-md">Kali</span>
                <span className="px-2 py-1 bg-red-100 text-red-700 text-xs font-semibold rounded-md">Penetrasyon</span>
        ...
        {/* 🎓 BÖLÜM 3: EĞİTİM & SERTİFİKALAR (Split Layout) */}
            ...
            <section className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-white shadow-lg">
                ...
                <div className="relative border-l-2 border-indigo-100 ml-3 space-y-8 pl-8 py-2">
                    <div className="relative">
                        ...
                        <p className="text-indigo-600 text-sm font-semibold mb-2">2023 - Günümüz</p>
                        <p className="text-gray-600 text-sm">Yazılım Mühendisliği bölümünde Veri Yapıları, OOP ve Algoritma Analizi üzerine derinleşiyorum.</p>
                    </div>
                    <div className="relative">
                ...
                <section className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-white shadow-lg">
                   ...
                   <div className="space-y-4">
                      <div className="p-4 bg-orange-50/50 rounded-xl border border-orange-100 hover:bg-orange-50 transition-colors">
                         <h4 className="font-bold text-gray-900 text-sm">Arduino İle Programlama</h4>
                      ...
                      <div className="p-4 bg-green-50/50 rounded-xl border border-green-100 hover:bg-green-50 transition-colors">
                         <h4 className="font-bold text-gray-900 text-sm">Kotlin Mobil Geliştirme</h4>
                         <p className="text-xs text-green-600 mt-1">Modern Android Mimarisi</p>
                      </div>
                   </div>
                </section>
                ...
                <section className="bg-gradient-to-br from-indigo-600 to-purple-700 p-8 rounded-3xl shadow-xl text-white relative overflow-hidden">
                   ...
                   <div className="relative z-10">
                      ...
                      <p className="text-xs text-indigo-200 mt-4 leading-relaxed">
                         Teknik dokümantasyon okuma, araştırma yapma ve global kaynakları takip etme yetkinliği.
                      </p>
                   </div>
                </section>
